...
lazy_static! {
    ...
    pub static ref BYTE_TOKENS: HashMap<Byte, TokenType> = [
        ...
        (Byte::Single(0x3A), TokenType::Number(".".into())),
        ...
        (Byte::Single(0x30), TokenType::Number("0".into())),
        (Byte::Single(0x31), TokenType::Number("1".into())),
        (Byte::Single(0x32), TokenType::Number("2".into())),
        (Byte::Single(0x33), TokenType::Number("3".into())),
        (Byte::Single(0x34), TokenType::Number("4".into())),
        (Byte::Single(0x35), TokenType::Number("5".into())),
        (Byte::Single(0x36), TokenType::Number("6".into())),
        (Byte::Single(0x37), TokenType::Number("7".into())),
        (Byte::Single(0x38), TokenType::Number("8".into())),
        (Byte::Single(0x39), TokenType::Number("9".into())),
