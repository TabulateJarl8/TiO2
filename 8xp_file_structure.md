...
| 60         | [File Type](#file-types) | The type of file. See the table below for more details.                                                                                                                                                                                                                | `5`, `6`                                                                                                                                    | `0x05`, `0x06`, etc                                                                                                                                                                                                 |                                       |
...
| 69         | Version                  | I'm not sure what this actually means, but it's usually `0x00`. Apparently this field is present if byte 56 is `0x0D`. [Source](https://gist.github.com/SimonEast/244a0fd04526ea1acbec2e2ceb2e7924?utm_source=chatgpt.com#file-8xp-file-format-ksy-L131)               | `00`                                                                                                                                        | `0x00`                                                                                                                                                                                                              |                                       |
| 70         | Archived Flag            | Whether or not this program is archived. `0x00` for normal programs, `0x80` for archived.                                                                                                                                                                              | `00` OR `128`                                                                                                                               | `0x00` OR `0x80`                                                                                                                                                                                                    |                                       |
