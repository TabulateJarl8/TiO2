...
| 68         | Version                  | This flag seems to differentiate between different calculator versions. The TI-84 seems to use `0x00` for everything I've seen, but this is important in some other cases. For example, the TI-82 has `0x0C` for the "Zoom" (`.82z`) file type byte, but differentiates it from the TI-84's "Complex" file type with a version of `0x9B` | `00`                                                                                                                                        | `0x00`                                                                                                                                                                                                              |                                       |
